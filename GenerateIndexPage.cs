  ...
  private async Task GenerateIndexPage()
  {
    ...
    <div class='container landing-page'>
        ...
        <div class='landing-content'>
            <p>Welcome to the Keith Long Archive, an attempt to create a complete visual documentation of a lifetime of artwork.</p>
            ...
            such as title, date, medium, dimensions, purchase date and any other relevant details.</p>
